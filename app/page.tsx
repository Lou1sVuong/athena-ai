  ...
  const handleSendMessage = async () => {
    if (isConnected && inputMessage.trim()) {
      const getRoute = await fetch(
        `https://zap-api.kyberswap.com/base/api/v1/in/route?dex=DEX_UNISWAPV2&pool.id=0xf6ad6baafdac1b15bcde4f94d6ad412620b55405&position.id=${address}&tokensIn=0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE&amountsIn=100000000&slippage=5`
      );
      if (!getRoute.ok) {
